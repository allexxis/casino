...
export default function Index() {
   ...
   return (
      <div className="bg-white ">
         ...
         {/* Header */}
         <header className="backdrop-blur-2xl absolute inset-x-0 top-0 z-50">
            <nav
         ...
         <main className="backdrop-blur-2xl isolate">
            {/* Hero section */}
         ...
         {/* Footer */}
         <div className=" backdrop-blur-2xl mx-auto mt-32 max-w-7xl px-6 lg:px-8">
            <footer
